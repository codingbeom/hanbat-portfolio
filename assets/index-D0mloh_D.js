...
`,Be=n.h2`
	...
	animation: ${Pe} 3.5s linear infinite;
	margin-bottom: 32px;
`,Fe=n.div`
	display: grid;
...
`,ss=n.h2`
	...
	-webkit-background-clip: text;
	-webkit-text-fill-color: transparent;
	animation: ${Je} 3.5s linear infinite;
	margin-bottom: 32px;
`,ns=n.div`
	display: inline-flex;
	flex-direction: column;
...
`,O=n.p`
	...
	opacity: 0.85;
	color: #cbd5f5;
`,us=()=>e.jsxs("section",{children:[e.jsx(g,{children:"DISTINCT 중복 제거"}),e.jsx(u,{children:e.jsxs("code",{children:[e.jsx("span",{className:"comment",children:"-- 주문이 있는 사용자 목록을 중복 없이 조회"}),`
...
`,e.jsx("span",{className:"keyword",children:"WHERE"})," age < 25"," ",e.jsx("span",{className:"keyword",children:"OR"})," age > 30;"]})})]},"4"),Cs=()=>e.jsxs("section",{children:[e.jsx(g,{children:"WHERE 절 활용 - 2"}),e.jsx(u,{children:e.jsxs("code",{children:[e.jsx("span",{className:"comment",children:"-- IN 조건 (age가 25, 30, 35인 users 테이블의 모든 데이터 조회)"}),`
`,e.jsx("span",{className:"keyword",children:"SELECT"})," *"," ",e.jsx("span",{className:"keyword",children:"FROM"})," users",`
...
`,e.jsx("span",{className:"keyword",children:"SELECT"})," *"," ",e.jsx("span",{className:"keyword",children:"FROM"})," users",`
`,e.jsx("span",{className:"keyword",children:"WHERE"})," age"," ",e.jsx("span",{className:"keyword",children:"BETWEEN"})," 25"," ",e.jsx("span",{className:"keyword",children:"AND"})," 30;"]})})]},"5"),zs=()=>e.jsxs("section",{children:[e.jsx(g,{children:"WHERE 조건절"}),e.jsx(u,{children:e.jsxs("code",{children:[e.jsx("span",{className:"keyword",children:"SELECT"})," *"," ",e.jsx("span",{className:"keyword",children:"FROM"})," users",`
`,e.jsx("span",{className:"keyword",children:"WHERE"})," age > 25;"]})}),e.jsx(v,{children:e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("strong",{children:"WHERE"}),": 특정 조건을 필터링"]}),e.jsx("li",{children:"비교 연산자: =, !=, >, <, >=, <="}),e.jsx("li",{children:"논리 연산자: AND, OR, NOT"}),e.jsx("li",{children:"패턴 매칭: LIKE, ILIKE(대소문자 구분 X)"}),e.jsx("li",{children:"NULL 체크: IS NULL, IS NOT NULL"})]})})]},"3"),Ts=()=>{const s=d.useRef(null),r=d.useRef(null);return d.useEffect(()=>{if(!r.current)return r.current=new H(s.current,{width:1500,height:900,transition:"slide",hash:!0,controls:!0,progress:!0,slideNumber:"c/t",embedded:!0,mouseWheel:!0}),r.current.initialize().then(()=>{console.log("Reveal.js initialized successfully")}),()=>{try{r.current&&(r.current.destroy(),r.current=null)}catch{console.warn("Reveal.js destroy call failed.")}}},[]),e.jsx("div",{className:"reveal",ref:s,style:{height:"calc(100vh - 60px)"},children:e.jsxs("div",{className:"slides",children:[e.jsx($s,{}),e.jsx(Ss,{}),e.jsx(vs,{}),e.jsx(zs,{}),e.jsx(Es,{}),e.jsx(Cs,{}),e.jsx(ks,{}),e.jsx(bs,{}),e.jsx(fs,{}),e.jsx(ws,{}),e.jsx(us,{}),e.jsx(ys,{}),e.jsx(Ns,{})]})})},_=n.h1`
	font-size: 3em !important;
	margin-bottom: 20px !important;
	text-shadow: 0 14px 30px rgba(4, 11, 20, 0.45) !important;
	color: #f9fafb !important;
...
`;n.div`
	...
	align-items: flex-start;
	flex-wrap: wrap;
`;const Os=()=>e.jsxs("section",{children:[e.jsx(j,{children:"집계 (Aggregation Pipeline)"}),e.jsx(y,{children:e.jsxs("code",{children:[e.jsx("span",{className:"comment",children:"// 나라별 평균 나이가 30세 이상인 국가 조회"}),`
...
`,e.jsx("span",{className:"function",children:"db"}),".users.",e.jsx("span",{className:"keyword",children:"deleteMany"}),"(","{}",")"]})}),e.jsx(k,{children:e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("strong",{children:"deleteOne()"}),": 조건에 맞는 도큐먼트 중 첫 번째만 삭제합니다."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"deleteMany()"}),": 조건에 맞는 모든 도큐먼트를 삭제합니다."]}),e.jsxs("li",{children:["빈 쿼리 ",e.jsx("code",{style:{color:"#fde68a"},children:"{}"})," 를 사용하면 컬렉션의 모든 데이터를 삭제하므로 주의가 필요합니다."]})]})})]}),Ls=()=>e.jsxs("section",{children:[e.jsx(j,{children:"조회 (Find)"}),e.jsx(y,{children:e.jsxs("code",{children:[e.jsx("span",{className:"comment",children:"// 전체 조회 (SQL: SELECT * FROM users)"}),`
...
`,e.jsx("span",{className:"function",children:"db"}),".users.",e.jsx("span",{className:"keyword",children:"getIndexes"}),"()"]})}),e.jsx(k,{children:e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("strong",{children:"1"})," = 오름차순 인덱스, ",e.jsx("strong",{children:"-1"})," = 내림차순 인덱스"]}),e.jsx("li",{children:"자주 조회하는 필드에 인덱스를 생성하면 쿼리 성능이 크게 향상됩니다."}),e.jsx("li",{children:"인덱스가 많으면 쓰기 성능이 저하될 수 있으므로 필요한 것만 생성합니다."})]})})]}),Ps=()=>e.jsxs("section",{children:[e.jsx(j,{children:"삽입 (Insert)"}),e.jsx(y,{children:e.jsxs("code",{children:[e.jsx("span",{className:"comment",children:"// 단일 도큐먼트 삽입"}),`
...
`,"}"]})})]}),Ms=()=>e.jsxs("section",{"data-background-gradient":"linear-gradient(to bottom, #065f46, #064e3b)",children:[e.jsx(_,{children:"감사합니다!"}),e.jsxs(K,{children:["사용도구: React, Reveal.js, styled-components ",e.jsx("br",{}),"참고: Copilot, MongoDB 공식 문서"]})]}),Bs=()=>e.jsxs(e.Fragment,{children:[e.jsxs("section",{children:[e.jsx(j,{children:"쿼리 연산자 — 비교 연산자"}),e.jsx(y,{children:e.jsxs("code",{children:[e.jsx("span",{className:"comment",children:"// $eq: 같음, $ne: 다름"}),`
...
`,e.jsx("span",{className:"function",children:"db"}),".users.",e.jsx("span",{className:"keyword",children:"find"}),"(","({",`
`,e.jsx("span",{className:"operator",children:"age"}),": ","{ ",e.jsx("span",{className:"keyword",children:"$in"}),": [25, 30, 35] ","}","})"]})}),e.jsx(k,{children:e.jsxs("ul",{children:[e.jsxs("li",{children:["MongoDB의 쿼리 연산자는 ",e.jsx("code",{style:{color:"#67e8f9"},children:"$"}),"로 시작합니다."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"$regex"}),"를 이용하면 SQL의 ",e.jsx("code",{children:"LIKE"}),"와 같은 패턴 매칭도 가능합니다."]})]})})]}),e.jsxs("section",{children:[e.jsx(j,{children:"쿼리 연산자 — 논리 연산자"}),e.jsx(y,{children:e.jsxs("code",{children:[e.jsx("span",{className:"comment",children:"// $and: 모든 조건 만족"}),`
`,e.jsx("span",{className:"function",children:"db"}),".users.",e.jsx("span",{className:"keyword",children:"find"}),"(","({",`
...
`,ln=n.h2`
	...
	-webkit-background-clip: text;
	-webkit-text-fill-color: transparent;
	animation: ${rn} 3.5s linear infinite;
	margin-bottom: 6px;
`,cn=n.p`
	font-size: 13px;
	color: #6b7280;
...
`,un=({id:s,imageUrl:r,posX:o,posY:a,currentPos:i,movePiece:c,size:x})=>{const[{isDragging:E},l]=xe({type:M,item:{id:s},collect:S=>({isDragging:S.isDragging()})}),[,C]=pe({accept:M,drop:S=>{c(S.id,s)}});return e.jsx(gn,{ref:S=>l(C(S)),$imageUrl:r,$posX:o,$posY:a,$isDragging:E,$size:x})},bn=n.div`
	width: 100%;
	padding: 60px 24px;
`,fn=n.div`
	width: 100%;
...
`,vn=["JPEG","PNG","JPG"],Sn={backends:[{backend:me,preview:!0},{backend:je,options:{enableMouseEvents:!0},preview:!0,transition:be}]},A=[{size:4,label:"하 (4×4)"},{size:8,label:"중 (8x8)"},{size:12,label:"상 (12x12)"}];function $n(){const[s,r]=d.useState(null),[o,a]=d.useState(""),[i,c]=d.useState([]),[x,E]=d.useState(A[0]),l=t=>{r(t);const p=URL.createObjectURL(t);a(p)},C=t=>{for(let p=t.length-1;p>0;p--){const m=Math.floor(Math.random()*(p+1));[t[p],t[m]]=[t[m],t[p]]}return t},S=(t,p)=>{const m=i.findIndex(b=>b.id===t),$=i.findIndex(b=>b.id===p),h=[...i];[h[m],h[$]]=[h[$],h[m]],c(h)},X=()=>{if(s){const t=x.size,p=[],m=100/(t-1);for(let h=0;h<t;h++)for(let b=0;b<t;b++)p.push({id:`${h*t+b}`,originalPos:{row:h,col:b},currentPos:{row:h,col:b},posX:b*m,posY:h*m});const $=C(p);c($)}};d.useEffect(()=>{X()},[s,x]),d.useEffect(()=>{if(i.length>0){const t=x.size;i.every((m,$)=>m.originalPos.row===Math.floor($/t)&&m.originalPos.col===$%t)&&alert("정답입니다! 다른 이미지로 도전해보세요!")}},[i,x]);const Z=()=>{r(null),c([]),a("")},ee=t=>{E(t)};return e.jsx(bn,{children:e.jsxs(fn,{children:[e.jsxs(yn,{children:[e.jsx("h2",{children:"Puzzle"}),s?e.jsx(B,{children:e.jsx(F,{onClick:Z,children:"초기화"})}):e.jsx(B,{children:A.map(t=>e.jsx(F,{onClick:()=>ee(t),className:x.size===t.size?"active":"",children:t.label},t.size))})]}),e.jsxs(wn,{children:[s?e.jsx(he,{backend:ue,options:Sn,children:e.jsx(kn,{$size:x.size,children:i.map(t=>e.jsx(un,{id:t.id,imageUrl:o,posX:t.posX,posY:t.posY,currentPos:t.currentPos,movePiece:S,size:x.size},t.id))})}):e.jsx(ge,{classes:"dnd",onSizeError:()=>alert("파일 사이즈가 너무 큽니다(2MB)"),handleChange:l,onDrop:l,name:"file",types:vn,multiple:!1,label:"사진을 업로드하면 퍼즐이 만들어집니다.",required:!0}),s&&e.jsx(Nn,{src:o,alt:"Original"})]})]})})}const En=[[{name:"Html5",value:.9,color:"#E44D26"},{name:"Css3",value:.8,color:"#264DE4"},{name:"TypeScript",value:.8,color:"#3178C6"},{name:"Flutter",value:.7,color:"#02569B"}],[{name:"Vue3",value:.7,color:"#42B883"},{name:"React",value:.9,color:"#61DAFB"},{name:"Python",value:.8,color:"#3776AB"},{name:"Vite",value:.6,color:"#646CFF"}],[{name:"Nginx",value:.5,color:"#009639"},{name:"MySql",value:.6,color:"#4479A1"},{name:"Ubuntu",value:.7,color:"#E95420"},{name:"Electron.js",value:.7,color:"#47848F"}],[{name:"Node.js",value:.8,color:"#339933"},{name:"Bun.js",value:.5,color:"#c8a97e"},{name:"Redis",value:.6,color:"#DC382D"}]],Cn={hidden:{opacity:0,y:60},visible:s=>({opacity:1,y:0,transition:{duration:.5,delay:s*.08,ease:"easeOut"}})},zn=N`
	0%   { background-position: -200% center; }
	100% { background-position: 200% center; }
`,Tn=n(f.section)`
	padding: 60px 0 80px;
...
`,In=n.div`
	...
	h2 {
		...
		-webkit-background-clip: text;
		-webkit-text-fill-color: transparent;
		animation: ${zn} 3s linear infinite;
		margin-bottom: 8px;
	}
...
`;function Bn({skill:s,index:r}){return e.jsxs(Rn,{$color:s.color,custom:r,variants:Cn,initial:"hidden",whileInView:"visible",viewport:{once:!0,amount:.2},children:[e.jsx(Pn,{$color:s.color,children:s.name}),e.jsx(Dn,{children:e.jsx(fe,{value:s.value,maxValue:1,text:`${Math.round(s.value*100)}%`,styles:we({pathColor:s.color,textColor:s.color,trailColor:"#2e3640",textSize:"20px"})})}),e.jsx(Mn,{children:`${Math.round(s.value*100)}%`})]})}function Fn(){return e.jsx(Tn,{initial:{opacity:0},whileInView:{opacity:1},viewport:{once:!1},transition:{duration:.6},children:e.jsxs(On,{children:[e.jsxs(In,{children:[e.jsx("h2",{children:"Skill"}),e.jsx("p",{children:"Technologies I work with"})]}),En.map((s,r)=>e.jsx(Ln,{children:s.map((o,a)=>e.jsx(Bn,{skill:o,index:r*4+a},o.name))},r))]})})}const An=N`
	0%   { transform: translateY(0); }
	100% { transform: translateY(-3px); }
`,Gn=n.nav`
	position: sticky;
...
`,Vn=n.a`
	...
	&:hover {
		background: rgba(118, 171, 174, 0.12);
		color: #a8d8da;
		animation: ${An} 0.4s ease infinite alternate;
	}
...
`,Yn=["✏️","🔢","🎮","⭐"];function Wn({story:s}){function r(o){o.preventDefault();const a=o.currentTarget.getAttribute("href");if(!a)return;const i=document.querySelector(a);i&&i.scrollIntoView({behavior:"smooth",block:"center"})}return e.jsx(Gn,{children:e.jsx("ul",{children:s.map((o,a)=>e.jsx("li",{children:e.jsxs(Vn,{href:o.href,$flipped:o.flip,onClick:r,children:[e.jsx("span",{children:Yn[a]}),o.name]})},a))})})}const Hn="/hanbat-portfolio/assets/001-QaaCS8Xj.png",Qn="/hanbat-portfolio/assets/002-CoGtfpOr.png",Un="/hanbat-portfolio/assets/003-Bkjd7iTY.png",_n="/hanbat-portfolio/assets/004-Dd-qRShE.png",Jn=n(f.div)`
	width: 100%;
	padding: 20px;
`,G=n.section`
	width: 100%;
...
`;function qn(){const[s,r]=d.useState([{href:"#name",name:"나의 이름 삼행시",img:Hn,flip:!1},{href:"#number",name:"숫자 아이덴티티",img:Qn,flip:!1},{href:"#hobby",name:"취미 생활",img:Un,flip:!1},{href:"#model",name:"나의 롤모델",img:_n,flip:!1}]),o=a=>{r(s.map(i=>a===i.href?{...i,flip:!i.flip}:{...i}))};return e.jsxs(Jn,{initial:{opacity:0,y:100},whileInView:{opacity:1,y:0},viewport:{once:!1},transition:{ease:"easeInOut",duration:2,y:{duration:1}},children:[e.jsx(Wn,{story:s}),s.map((a,i)=>e.jsxs(ye,{isFlipped:a.flip,flipDirection:"horizontal",children:[e.jsx(G,{id:a.href.replace(/^#/,""),onClick:()=>o(a.href),children:e.jsx(V,{children:e.jsx("div",{children:e.jsx("h2",{children:a.name})})})}),e.jsx(G,{id:a.href.replace(/^#/,""),onClick:()=>o(a.href),children:e.jsx(V,{children:e.jsx("img",{src:a.img,alt:a.name})})})]},i))]})}function Kn(){return e.jsxs("div",{children:[e.jsx("h1",{children:"Supabase PPT Placeholder"}),e.jsx("p",{children:"This is where the Supabase presentation will go."})]})}function Xn(){return e.jsx(e.Fragment,{children:e.jsx(Re,{children:e.jsxs(te,{children:[e.jsx(w,{index:!0,path:"/",element:ms()}),e.jsx(w,{path:"/story",element:qn()}),e.jsx(w,{path:"/skill",element:Fn()}),e.jsx(w,{path:"/contact",element:Qe()}),e.jsx(w,{path:"/project",element:jn()}),e.jsx(w,{path:"/puzzle",element:$n()}),e.jsx(w,{path:"/presentation",element:e.jsx(Ts,{})}),e.jsx(w,{path:"/nosql",element:e.jsx(Ys,{})}),e.jsx(w,{path:"/supa",element:e.jsx(Kn,{})})]})})})}const Zn={createGlobalStyle:W},er=Zn.createGlobalStyle`
	*,
	*::after,
	*::before {
		padding: 0;
...
`;console.log("/hanbat-portfolio");ne.createRoot(document.getElementById("root")).render(e.jsx(ie,{shouldForwardProp:se,children:e.jsxs(re,{basename:"/hanbat-portfolio",children:[e.jsx(er,{}),e.jsx(Xn,{})]})}));
