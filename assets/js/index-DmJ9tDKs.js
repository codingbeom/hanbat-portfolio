import{r as d,j as e}from"./vendor/react-Cn5bQk0m.js";import{i as de}from"./vendor/@emotion/is-prop-valid-CbYjyf98.js";import{c as xe}from"./vendor/react-dom-DVo-cL-5.js";import{L as X,B as he}from"./vendor/react-router-dom-eO2hXw-C.js";/* empty css                              */import{E as N,g as n,f as P,S as K,t as pe}from"./vendor/styled-components-PWTcbKOv.js";import{c as je,b as me,R as k}from"./vendor/react-router-CiQM1lDE.js";import{m as w}from"./vendor/framer-motion-1DZjBxfC.js";import{G as ge,E as ue,a as be}from"./vendor/react-bootstrap-icons-BspAuGHH.js";import{X as D}from"./vendor/reveal.js-C7gWY-cu.js";import{S as fe}from"./vendor/react-slick-BAGD-DDz.js";import{u as ye,a as we,D as Ne}from"./vendor/react-dnd-BJQdTadb.js";import{H as ke}from"./vendor/react-dnd-html5-backend-DRsOmgOT.js";import{T as Se}from"./vendor/react-dnd-touch-backend-Bhq8oVci.js";import{E as ve}from"./vendor/react-drag-drop-files-D6Ig5xf_.js";import{L as Ee,S as $e}from"./vendor/dnd-multi-backend-YSGhLC9z.js";import{C as Le,b as Ie}from"./vendor/react-circular-progressbar-BDe-Zf0g.js";import{_ as Te}from"./vendor/react-card-flip-BIlRI9x2.js";import"./vendor/scheduler-D8Or_Z1e.js";import"./vendor/@remix-run/router-BJTnPK-x.js";import"./vendor/stylis-DRmxwqWu.js";import"./vendor/motion-dom-yOzW5nAz.js";import"./vendor/motion-utils-C46sbb7m.js";import"./vendor/prop-types-DKbQLeq-.js";import"./vendor/lodash.debounce-KP93gKah.js";import"./vendor/classnames-DTKT5ssy.js";import"./vendor/resize-observer-polyfill-BelwliC0.js";import"./vendor/json2mq-DXkj81uw.js";import"./vendor/string-convert-DdSrkZLz.js";import"./vendor/enquire.js-B8qsBZnP.js";import"./vendor/dnd-core-CQu-fmHL.js";import"./vendor/redux-BFxtlG_c.js";import"./vendor/@react-dnd/invariant-CpXzGp22.js";import"./vendor/@react-dnd/asap-kGd5DMWm.js";import"./vendor/@react-dnd/shallowequal-D1ZyZBg9.js";import"./vendor/fast-deep-equal-CKcC8hVQ.js";import"./vendor/tslib-CGNu0TuM.js";import"./vendor/@emotion/unitless-sScrWPmR.js";(function(){const r=document.createElement("link").relList;if(r&&r.supports&&r.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))t(i);new MutationObserver(i=>{for(const c of i)if(c.type==="childList")for(const x of c.addedNodes)x.tagName==="LINK"&&x.rel==="modulepreload"&&t(x)}).observe(document,{childList:!0,subtree:!0});function l(i){const c={};return i.integrity&&(c.integrity=i.integrity),i.referrerPolicy&&(c.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?c.credentials="include":i.crossOrigin==="anonymous"?c.credentials="omit":c.credentials="same-origin",c}function t(i){if(i.ep)return;i.ep=!0;const c=l(i);fetch(i.href,c)}})();const Ce=N`
...
`,Be=n(X)`
	...
	&:hover {
		animation: ${Ce} 0.4s ease infinite alternate;
		color: #76abae;
	}
`,Me=n.button`
	display: flex;
...
`,O=[{href:"/",name:"Home",emoji:"🏠"},{href:"/project",name:"Project",emoji:"📁"},{href:"/skill",name:"Skill",emoji:"⚡"},{href:"/story",name:"Story",emoji:"📖"},{href:"/contact",name:"Contact",emoji:"✉️"},{href:"/puzzle",name:"Puzzle",emoji:"🧩"},{href:"/presentation",name:"MySQL",emoji:"📊"},{href:"/nosql",name:"MongoDB",emoji:"🍃"},{href:"/supa",name:"Supabase",emoji:"💾"}];function Ge({children:s}){const r=je(),[l,t]=d.useState(!0),[i,c]=d.useState(!1),x=o=>r.pathname===o;return d.useEffect(()=>{if(r.pathname!=="/story")return;const o=()=>t(window.scrollY<=60);return document.addEventListener("scroll",o,{passive:!0}),()=>document.removeEventListener("scroll",o)},[r.pathname]),d.useEffect(()=>{c(!1)},[r.pathname]),d.useEffect(()=>(document.body.style.overflow=i?"hidden":"",()=>{document.body.style.overflow=""}),[i]),e.jsxs(Oe,{children:[e.jsxs(Pe,{$visible:l,children:[e.jsx(De,{children:O.find(o=>o.href===r.pathname)?.name??"✦"}),e.jsx(Ae,{children:O.map(o=>e.jsx("li",{children:e.jsx(Be,{to:o.href,$active:x(o.href),children:o.name})},o.href))}),e.jsxs(Me,{$open:i,onClick:()=>c(o=>!o),"aria-label":"메뉴 열기/닫기","aria-expanded":i,children:[e.jsx("span",{}),e.jsx("span",{}),e.jsx("span",{})]})]}),e.jsx(Fe,{$open:i,onClick:()=>c(!1)}),e.jsx(We,{$open:i,role:"menu",children:O.map(o=>e.jsx("li",{role:"none",children:e.jsxs(Qe,{to:o.href,$active:x(o.href),role:"menuitem",onClick:()=>c(!1),children:[e.jsx("span",{children:o.emoji}),o.name]})},o.href))}),s]})}const Ve=N`
...
`;function Q({entry:s,index:r}){return e.jsx(us,{custom:r,variants:ts,initial:"hidden",whileInView:"visible",viewport:{once:!0,amount:.2},children:e.jsxs(bs,{children:[e.jsx(fs,{children:s.title}),e.jsx(ys,{children:s.period}),s.sub&&e.jsx(ws,{children:s.sub}),s.bullets&&e.jsx(Ns,{children:s.bullets.map((l,t)=>e.jsx("li",{children:l},t))})]})})}function ks(){return e.jsx(ls,{initial:{opacity:0},whileInView:{opacity:1},viewport:{once:!1},transition:{duration:.6},children:e.jsxs(os,{children:[e.jsxs(cs,{children:[e.jsx(ds,{children:"Career"}),e.jsxs(xs,{children:[e.jsx(hs,{children:"이기범 · Frontend / Software Engineer"}),e.jsxs(ps,{children:["전기 분야 실무 경험을 바탕으로 소프트웨어 개발로 전환, 현재 프론트엔드 및 크로스플랫폼 개발자로 성장하고 있습니다.",e.jsx("br",{}),"문제를 끝까지 파고드는 성격으로 React, Flutter, Python 기반 음성인식 서버까지 폭넓게 다루며, 인공지능 · 빅데이터 분야로의 확장을 목표로 한밭대학교 소프트웨어응용학과에서 학업을 이어가고 있습니다."]}),e.jsx(js,{children:["Frontend","Backend","Electron","Flutter","Python","AI/STT","DevOps"].map(s=>e.jsx(ms,{children:s},s))})]})]}),e.jsxs(gs,{children:[e.jsxs("div",{children:[e.jsx(F,{children:"📚 Education"}),e.jsx(W,{children:ns.map((s,r)=>e.jsx(Q,{entry:s,index:r},s.title))})]}),e.jsxs("div",{children:[e.jsx(F,{children:"💼 Work Experience"}),e.jsx(W,{children:rs.map((s,r)=>e.jsx(Q,{entry:s,index:r},s.title))})]})]})]})})}const ee=n.h1`
...
`,e.jsx("span",{className:"keyword",children:"WHERE"})," age > 25;"]})}),e.jsx(L,{children:e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("strong",{children:"WHERE"}),": 특정 조건을 필터링"]}),e.jsx("li",{children:"비교 연산자: =, !=, >, <, >=, <="}),e.jsx("li",{children:"논리 연산자: AND, OR, NOT"}),e.jsx("li",{children:"패턴 매칭: LIKE, ILIKE(대소문자 구분 X)"}),e.jsx("li",{children:"NULL 체크: IS NULL, IS NOT NULL"})]})})]},"3"),Ms=()=>{const s=d.useRef(null),r=d.useRef(null);return d.useEffect(()=>{if(!r.current)return r.current=new D(s.current,{width:1500,height:900,transition:"slide",hash:!0,controls:!0,progress:!0,slideNumber:"c/t",embedded:!0,mouseWheel:!0}),r.current.initialize().then(()=>{}),()=>{try{r.current&&(r.current.destroy(),r.current=null)}catch{}}},[]),e.jsx("div",{className:"reveal",ref:s,style:{height:"calc(100vh - 60px)"},children:e.jsxs("div",{className:"slides",children:[e.jsx(Ps,{}),e.jsx(Os,{}),e.jsx(zs,{}),e.jsx(Bs,{}),e.jsx(Ds,{}),e.jsx(As,{}),e.jsx(Cs,{}),e.jsx($s,{}),e.jsx(Ls,{}),e.jsx(Is,{}),e.jsx(Es,{}),e.jsx(Ts,{}),e.jsx(Rs,{})]})})},se=n.h1`
	font-size: 3em !important;
	margin-bottom: 20px !important;
	text-shadow: 0 14px 30px rgba(4, 11, 20, 0.45) !important;
	color: #f9fafb !important;
...
`,En=({id:s,imageUrl:r,posX:l,posY:t,currentPos:i,movePiece:c,size:x})=>{const[{isDragging:o},R]=ye({type:U,item:{id:s},collect:I=>({isDragging:I.isDragging()})}),[,z]=we({accept:U,drop:I=>{c(I.id,s)}});return e.jsx(vn,{ref:I=>R(z(I)),$imageUrl:r,$posX:l,$posY:t,$isDragging:o,$size:x})},$n=N`
	0%   { background-position: -200% center; }
	100% { background-position:  200% center; }
`,Ln=n.div`
	width: 100%;
...
`,On=["JPEG","PNG","JPG"],Pn={backends:[{backend:ke,preview:!0},{backend:Se,options:{enableMouseEvents:!0},preview:!0,transition:Ee}]},_=[{size:4,label:"하 (4×4)"},{size:8,label:"중 (8x8)"},{size:12,label:"상 (12x12)"}];function Dn(){const[s,r]=d.useState(null),[l,t]=d.useState(""),[i,c]=d.useState([]),[x,o]=d.useState(_[0]),R=a=>{r(a);const p=URL.createObjectURL(a);t(p)},z=a=>{for(let p=a.length-1;p>0;p--){const m=Math.floor(Math.random()*(p+1));[a[p],a[m]]=[a[m],a[p]]}return a},I=(a,p)=>{const m=i.findIndex(y=>y.id===a),T=i.findIndex(y=>y.id===p),j=[...i];[j[m],j[T]]=[j[T],j[m]],c(j)},le=()=>{if(s){const a=x.size,p=[],m=100/(a-1);for(let j=0;j<a;j++)for(let y=0;y<a;y++)p.push({id:`${j*a+y}`,originalPos:{row:j,col:y},currentPos:{row:j,col:y},posX:y*m,posY:j*m});const T=z(p);c(T)}};d.useEffect(()=>{le()},[s,x]),d.useEffect(()=>{if(i.length>0){const a=x.size;i.every((m,T)=>m.originalPos.row===Math.floor(T/a)&&m.originalPos.col===T%a)&&alert("정답입니다! 다른 이미지로 도전해보세요!")}},[i,x]);const oe=()=>{r(null),c([]),t("")},ce=a=>{o(a)};return e.jsx(Ln,{children:e.jsxs(In,{children:[e.jsxs(Cn,{children:[!s&&e.jsx("h2",{children:"Puzzle"}),s?e.jsx(Y,{children:e.jsx(H,{onClick:oe,children:"초기화"})}):e.jsx(Y,{children:_.map(a=>e.jsx(H,{onClick:()=>ce(a),className:x.size===a.size?"active":"",children:a.label},a.size))})]}),e.jsxs(Tn,{children:[s?e.jsx(Ne,{backend:$e,options:Pn,children:e.jsx(Rn,{$size:x.size,children:i.map(a=>e.jsx(En,{id:a.id,imageUrl:l,posX:a.posX,posY:a.posY,currentPos:a.currentPos,movePiece:I,size:x.size},a.id))})}):e.jsx(ve,{classes:"dnd",onSizeError:()=>alert("파일 사이즈가 너무 큽니다(2MB)"),handleChange:R,onDrop:R,name:"file",types:On,multiple:!1,label:"사진을 업로드하면 퍼즐이 만들어집니다.",required:!0}),s&&e.jsx(zn,{src:l,alt:"Original"})]})]})})}const An=[[{name:"Html5",value:.9,color:"#E44D26"},{name:"Css3",value:.8,color:"#264DE4"},{name:"TypeScript",value:.8,color:"#3178C6"},{name:"Flutter",value:.7,color:"#02569B"}],[{name:"Vue3",value:.7,color:"#42B883"},{name:"React",value:.9,color:"#61DAFB"},{name:"Python",value:.8,color:"#3776AB"},{name:"Vite",value:.6,color:"#646CFF"}],[{name:"Nginx",value:.5,color:"#009639"},{name:"MySql",value:.6,color:"#4479A1"},{name:"Ubuntu",value:.7,color:"#E95420"},{name:"Electron.js",value:.7,color:"#47848F"}],[{name:"Node.js",value:.8,color:"#339933"},{name:"Bun.js",value:.5,color:"#c8a97e"},{name:"Redis",value:.6,color:"#DC382D"}]],Bn={hidden:{opacity:0,y:60},visible:s=>({opacity:1,y:0,transition:{duration:.5,delay:s*.08,ease:"easeOut"}})},Mn=N`
	0%   { background-position: -200% center; }
	100% { background-position: 200% center; }
`,Fn=n(w.section)`
	padding: 60px 0 80px;
...
`,Zn=["✏️","🔢","🎮","⭐"];function er({story:s}){function r(l){l.preventDefault();const t=l.currentTarget.getAttribute("href");if(!t)return;const i=document.querySelector(t);i&&i.scrollIntoView({behavior:"smooth",block:"center"})}return e.jsx(Xn,{children:e.jsx("ul",{children:s.map((l,t)=>e.jsx("li",{children:e.jsxs(Kn,{href:l.href,$flipped:l.flip,onClick:r,children:[e.jsx("span",{children:Zn[t]}),l.name]})},t))})})}const sr="/hanbat-portfolio/assets/001-QaaCS8Xj.png",nr="/hanbat-portfolio/assets/002-CoGtfpOr.png",rr="/hanbat-portfolio/assets/003-Bkjd7iTY.png",ir="/hanbat-portfolio/assets/004-Dd-qRShE.png",ar=n(w.div)`
	width: 100%;
	padding: 20px;
`,J=n.section`
	width: 100%;
...
`;function tr(){const[s,r]=d.useState([{href:"#name",name:"나의 이름 삼행시",img:sr,flip:!1},{href:"#number",name:"숫자 아이덴티티",img:nr,flip:!1},{href:"#hobby",name:"취미 생활",img:rr,flip:!1},{href:"#model",name:"나의 롤모델",img:ir,flip:!1}]),l=t=>{r(s.map(i=>t===i.href?{...i,flip:!i.flip}:{...i}))};return e.jsxs(ar,{initial:{opacity:0,y:100},whileInView:{opacity:1,y:0},viewport:{once:!1},transition:{ease:"easeInOut",duration:2,y:{duration:1}},children:[e.jsx(er,{story:s}),s.map((t,i)=>e.jsxs(Te,{isFlipped:t.flip,flipDirection:"horizontal",children:[e.jsx(J,{id:t.href.replace(/^#/,""),onClick:()=>l(t.href),children:e.jsx(q,{children:e.jsx("div",{children:e.jsx("h2",{children:t.name})})})}),e.jsx(J,{id:t.href.replace(/^#/,""),onClick:()=>l(t.href),children:e.jsx(q,{children:e.jsx("img",{src:t.img,alt:t.name})})})]},i))]})}const ae=n.h1`
	font-size: 3em !important;
	margin-bottom: 20px !important;
...
`;xe.createRoot(document.getElementById("root")).render(e.jsx(pe,{shouldForwardProp:de,children:e.jsxs(he,{basename:"/hanbat-portfolio/",future:{v7_startTransition:!0,v7_relativeSplatPath:!0},children:[e.jsx(kr,{}),e.jsx(wr,{})]})}));
